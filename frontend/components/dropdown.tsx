...
export function DropdownItem({
  ...
  const classes = clsx(
    ...
    // Text styles
    'text-left text-base/6 text-zinc-950 sm:text-sm/6 text-white forced-colors:text-[CanvasText]',
    // Focus
    ...
    '*:data-[slot=icon]:text-zinc-500 data-focus:*:data-[slot=icon]:text-white *:data-[slot=icon]:text-zinc-400 data-focus:*:data-[slot=icon]:text-white',
    // Avatar
...
export function DropdownHeading({
  ...
  return (
    <Headless.MenuHeading
      ...
      className={clsx(
        className,
        'col-span-full grid grid-cols-[1fr_auto] gap-x-12 px-3.5 pt-2 pb-1 text-sm/5 font-medium text-zinc-500 sm:px-3 sm:text-xs/5 text-zinc-400'
      )}
    />
  )
}
...
export function DropdownDivider({
  ...
  return (
    <Headless.MenuSeparator
      ...
      className={clsx(
        className,
        'col-span-full mx-3.5 my-1 h-px border-0 bg-zinc-950/5 sm:mx-3 bg-white/10 forced-colors:bg-[CanvasText]'
      )}
    />
  )
}
...
export function DropdownDescription({
  ...
  return (
    <Headless.Description
      ...
      className={clsx(
        className,
        'col-span-2 col-start-2 row-start-2 text-sm/5 text-zinc-500 group-data-focus:text-white sm:text-xs/5 text-zinc-400 forced-colors:group-data-focus:text-[HighlightText]'
      )}
    />
  )
}
