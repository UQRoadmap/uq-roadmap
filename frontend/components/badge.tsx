...
const colors = {
  ...
  sky: 'bg-sky-500/15 text-sky-700 group-data-hover:bg-sky-500/25 bg-sky-500/10 text-sky-300 group-data-hover:bg-sky-500/20',
  blue: 'bg-blue-500/15 text-blue-700 group-data-hover:bg-blue-500/25 text-blue-400 group-data-hover:bg-blue-500/25',
  indigo:
    'bg-indigo-500/15 text-indigo-700 group-data-hover:bg-indigo-500/25 text-indigo-400 group-data-hover:bg-indigo-500/20',
  violet:
  ...
  zinc: 'bg-zinc-600/10 text-zinc-700 group-data-hover:bg-zinc-600/20 bg-white/5 text-zinc-400 group-data-hover:bg-white/10',
}
